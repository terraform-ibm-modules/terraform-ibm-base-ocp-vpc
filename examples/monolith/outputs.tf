...
output "vpc_name" {
  ...
  value       = module.monolith_add_ons.vpc_name
}

output "vpc_id" {
  description = "ID of the VPC created."
  value       = module.monolith_add_ons.vpc_id
}

output "vpc_crn" {
  description = "CRN of the VPC created."
  value       = module.monolith_add_ons.vpc_crn
}
...
output "public_gateways" {
  ...
  value       = module.monolith_add_ons.public_gateways
}
...
output "vpc_flow_logs" {
  ...
  value       = module.monolith_add_ons.vpc_flow_logs
}
...
output "network_acls" {
  ...
  value       = module.monolith_add_ons.network_acls
}
...
output "subnet_ids" {
  ...
  value       = module.monolith_add_ons.subnet_ids
}

output "private_path_subnet_id" {
  description = "The IDs of the subnets."
  value       = length(module.monolith_add_ons.subnet_ids) > 0 ? module.monolith_add_ons.subnet_ids[0] : null
}

output "subnet_detail_list" {
  description = "A list of subnets containing names, CIDR blocks, and zones."
  value       = module.monolith_add_ons.subnet_detail_list
}

output "subnet_zone_list" {
  description = "A list of subnet IDs and subnet zones."
  value       = module.monolith_add_ons.subnet_zone_list
}

output "subnet_detail_map" {
  description = "A map of subnets containing IDs, CIDR blocks, and zones."
  value       = module.monolith_add_ons.subnet_detail_map
}
...
output "vpn_gateways_name" {
  ...
  value       = module.monolith_add_ons.vpn_gateways_name
}

output "vpn_gateways_data" {
  description = "Details of VPN gateways data."
  value       = module.monolith_add_ons.vpn_gateways_data
}
...
output "vpe_ips" {
  ...
  value       = module.monolith_add_ons.vpe_ips
}

output "vpe_crn" {
  description = "The CRN of the endpoint gateway."
  value       = module.monolith_add_ons.vpe_crn
}
...
output "secrets_manager_guid" {
  ...
  value       = module.monolith_add_ons.secrets_manager_guid
}

output "secrets_manager_crn" {
  value       = module.monolith_add_ons.secrets_manager_crn
  description = "CRN of the Secrets Manager instance"
}

output "secrets_manager_region" {
  value       = module.monolith_add_ons.secrets_manager_region
...
output "cos_instance_crn" {
  ...
  value       = module.monolith_add_ons.cos_instance_crn
}

output "cos_instance_guid" {
  description = "COS instance guid"
  value       = module.monolith_add_ons.cos_instance_guid
}
...
output "cloud_monitoring_crn" {
  value       = module.monolith_add_ons.cloud_monitoring_crn
  description = "The id of the provisioned IBM Cloud Monitoring instance."
}
output "cloud_monitoring_name" {
  value       = module.monolith_add_ons.cloud_monitoring_name
...
output "cloud_monitoring_access_key_name" {
  value       = module.monolith_add_ons.cloud_monitoring_access_key_name
  description = "The name of the IBM Cloud Monitoring access key for agents to use"
}

output "cloud_monitoring_access_key" {
  value       = module.monolith_add_ons.cloud_monitoring_access_key
...
output "logs_bucket_crn" {
  ...
  value       = module.monolith_add_ons.logs_bucket_crn
}

output "metrics_bucket_crn" {
  description = "Metrics Cloud Object Storage bucket CRN"
  value       = module.monolith_add_ons.metrics_bucket_crn
}
...
output "activity_tracker_cos_target_bucket_name" {
  value       = module.monolith_add_ons.activity_tracker_cos_target_bucket_name
...
output "activity_tracker_targets" {
  value       = module.monolith_add_ons.activity_tracker_targets
  description = "The map of created Activity Tracker Event Routing targets"
}

output "activity_tracker_routes" {
  value       = module.monolith_add_ons.activity_tracker_routes
...
output "scc_workload_protection_id" {
  ...
  value       = module.monolith_add_ons.scc_workload_protection_id
}

output "scc_workload_protection_crn" {
  description = "SCC Workload Protection instance CRN"
  value       = module.monolith_add_ons.scc_workload_protection_crn
}

output "scc_workload_protection_name" {
  description = "SCC Workload Protection instance name"
  value       = module.monolith_add_ons.scc_workload_protection_name
}
