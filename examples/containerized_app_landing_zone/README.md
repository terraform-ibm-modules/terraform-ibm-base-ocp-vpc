...
* `Key Management (KMS)`: Optional provision and configuration of an IBM Key Protect instance for encrypting cluster and boot volumes. [Learn more](https://registry.terraform.io/modules/terraform-ibm-modules/kms-all-inclusive/ibm/5.4.5) about the service module.
