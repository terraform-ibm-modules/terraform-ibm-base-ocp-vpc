...
module "observability_instances" {
  source = "git::https://github.com/terraform-ibm-modules/terraform-ibm-observability-instances?ref=v2.8.0"
  providers = {
    logdna.at = logdna.at
    logdna.ld = logdna.ld
  }
...
module "observability_agents_1" {
  source = "git::https://github.com/terraform-ibm-modules/terraform-ibm-observability-agents.git?ref=v1.5.2"
  providers = {
