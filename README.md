...
| <a name="input_use_private_endpoint"></a> [use\_private\_endpoint](#input\_use\_private\_endpoint) | Enable if the runtime has to have access to private endpoints. | `bool` | `false` | no |
