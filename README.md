...
| <a name="input_use_private_endpoint"></a> [use\_private\_endpoint](#input\_use\_private\_endpoint) | Enable if the Terraform execution environment requires access to private endpoints. | `bool` | `false` | no |
