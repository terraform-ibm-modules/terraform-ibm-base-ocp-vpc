...
| <a name="input_enable_registry_backup"></a> [enable\_registry\_backup](#input\_enable\_registry\_backup) | Enable backup of OpenShift internal registry to standard Cloud Object Storage bucket | `bool` | `true` | no |
