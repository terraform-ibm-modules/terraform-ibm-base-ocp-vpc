...
| <a name="input_enable_registry_storage"></a> [enable\_registry\_storage](#input\_enable\_registry\_storage) | Enable storage of the OpenShift internal registry to a standard Cloud Object Storage bucket (recommended) | `bool` | `true` | no |
