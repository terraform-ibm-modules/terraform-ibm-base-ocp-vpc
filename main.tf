...
locals {
  ...
  disable_outbound_traffic_protection = local.ocp_version == "4.12_openshift" || var.ocp_version == "4.13_openshift" || var.ocp_version == "4.14_openshift" ? null : var.disable_outbound_traffic_protection
}
